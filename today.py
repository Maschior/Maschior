...
USER_NAME = os.environ.get('USER_NAME', 'Maschior')
...
def recursive_loc(owner, repo_name, data, cache_comment, addition_total=0, deletion_total=0, my_commits=0, cursor=None):
    ...
    if request.status_code in [401, 403, 404]:
        ...
        try:
            ...
            if 'message' in res_json and 'rate limit' in res_json['message'].lower():
                is_rate_limit = True
        except Exception:
            pass
...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    justify_format(root, 'follower_data', follower_data, 22)
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2002, 10, 4))
